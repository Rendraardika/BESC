          ...
          <div className="hidden items-center gap-3 md:flex">
            {user ? (
              <div className="relative">
                ...
                >
                  <span className="grid h-8 w-8 place-items-center rounded-full bg-[linear-gradient(180deg,#1c79c6,#044b86)] text-xs font-extrabold text-white">{userInitial}</span>
                  <span>{user.name}</span>
              ...
              {user ? (
                <div className="rounded-2xl bg-blue-50 p-4">
                  <div className="flex items-center gap-3">
                    <span className="grid h-10 w-10 place-items-center rounded-full bg-[linear-gradient(180deg,#1c79c6,#044b86)] text-sm font-extrabold text-white">{userInitial}</span>
                    <div>
