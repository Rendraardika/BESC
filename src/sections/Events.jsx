...
export default function Events({ onCompetitionDetail }) {
  return (
            ...
            <article key={event.title} className="overflow-hidden rounded-2xl border border-slate-200 bg-white transition hover:-translate-y-1 hover:border-[#1c79c6] hover:shadow-2xl">
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button type="button" onClick={() => onCompetitionDetail(index)} className="rounded-full bg-blue-100 px-4 py-2 text-xs font-extrabold text-[#044b86] transition hover:bg-[linear-gradient(180deg,#1c79c6,#044b86)] hover:text-white">Daftar</button>
                </div>
              </div>
            </article>
          ))}
