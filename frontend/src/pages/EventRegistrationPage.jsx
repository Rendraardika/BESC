            ...
            {currentStep === 1 && (
              <div>
                ...
                <form onSubmit={handleStep1Submit} className="space-y-4">
                  ...
                  <div className="rounded-xl border border-dashed border-slate-300 bg-white p-4"><h4 className="mb-3 text-sm font-bold text-slate-700">Anggota 1 {isLKTI ? '*' : '(opsional)'}</h4><PersonSection prefix="anggota1" form={form} setForm={setF} showNISN showUploads required={isLKTI} /></div>
                  ...
                  <div>
                    ...
                    <input className={fc} type="file" accept=".pdf" onChange={(e) => setF('_biodataKelompok', e.target.files?.[0])} required={isLKTI} />
                  </div>
