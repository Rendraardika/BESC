    ...
    <section className="bg-slate-50 px-6 py-20 md:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-7 lg:grid-cols-3">
          {[
            ['👩‍🎓', 'Achai Ridho Dhavita', 'SMA Negeri Blitar', 'Olimpiade BESC bermanfaat banget untuk melatih manajemen waktu dan berpikir kritis.'],
            ['👨‍🎓', 'Muhammad Lussy Zain', 'SMAN Madura', 'Dari BESC, saya belajar untuk berpikir kritis tentang konsep biologi dan teliti dalam mengerjakan soal.'],
            ['👩‍🔬', 'Kholifatul Ula', 'SMAN Sampang', 'Senang sekali bisa jadi Juara 1 Olimpiade Biologi BESC! Tetap optimis dan terus belajar.'],
